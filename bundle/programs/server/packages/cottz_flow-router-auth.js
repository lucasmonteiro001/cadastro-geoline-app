...
var FlowAuth = function () {                                                                             //
  function FlowAuth() {                                                                                  // 2
    ...
    this.authReady = new ReactiveVar(true);                                                              // 6
                                                                                                         ...
                                                                                                         //
  FlowAuth.prototype.allow = function () {                                                               //
    function allow(callback, options) {                                                                  //
    ...
    return allow;                                                                                        //
                                                                                                         ...
                                                                                                         //
  FlowAuth.prototype.allows = function () {                                                              //
    function allows(controllers) {                                                                       //
    ...
    return allows;                                                                                       //
                                                                                                         ...
                                                                                                         //
  FlowAuth.prototype.check = function () {                                                               //
    function check(path, group, redirect) {                                                              //
      var _this = this;                                                                                  // 39
                                                                                                         //
      var next = true;                                                                                   // 40
      var only = path;                                                                                   // 41
